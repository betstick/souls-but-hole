...
#from tools.importer import import_asset
...
class Scrub_Mesh_Weights(bpy.types.Operator):
	...
	def execute(self, context):
		...
		tools.verify.scrub_mesh_weights(bpy.context)
...
class Select_Overweighted_Verts(bpy.types.Operator):
	...
	def execute(self, context):
		...
		tools.verify.select_overweighted_verts(bpy.context)
